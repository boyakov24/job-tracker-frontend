    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div className="flex gap-2">
          <button
            type="button"
            className="rounded px-4 py-2 text-indigo-600 hover:bg-slate-100 transition-colors duration-200"
            onClick={(e) => {
              e.stopPropagation();
              setMode("login");
              setOpen(true);
          ...
          <button
            type="button"
            className="rounded bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700 transition-colors duration-200"
            onClick={(e) => {
              e.stopPropagation();
              setMode("register");
              setOpen(true);
